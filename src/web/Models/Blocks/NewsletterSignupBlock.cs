...
namespace OxxCommerceStarterKit.Web.Models.Blocks
{
    [ContentType(DisplayName = "Newsletter Signup", 
        GUID = "e76d019a-7d9f-4f42-b106-d5f691dc1353", Description = "A block to allow visitors to sign up to a newsletter")]
    [SiteImageUrl(thumbnail: EditorThumbnail.Newsletter)]
